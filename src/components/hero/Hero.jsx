  ...
  return (
    <div className='hero'>
      <div className="hSection left">
        <motion.h1 init={{ y:-100, opacity: 0 }} 
        ...
        className="awards">
          ...
          <motion.p variants={awardVariants} >Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur odio </motion.p>
      ...
      <div className="hSection right">
        ...
        >
          ...
          <motion.a variants={followVariants} href="/"> <img src="/youtube.png" alt=""/>
          </motion.a>
